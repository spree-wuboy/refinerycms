    ...
    class Engine < ::Rails::Engine
      ...
      def add_route_parts_as_reserved_words
        ActiveSupport.on_load(:active_record) do
          ...
          included_routes = Rails.application.routes.named_routes.names.map{|n| [n, Rails.application.routes.named_routes.get(n)]}.to_h.reject{ |name, route| route && route.defaults[:allow_slug] }
